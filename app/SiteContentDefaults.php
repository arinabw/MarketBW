...
final class SiteContentDefaults
{
    ...
    public static function defaults(array $settings): array
    {
        return [
            ...
            'home.hero_image' => '/images/hero-beadwork.svg',
            'home.hero_image_alt' => 'Украшения из бисера',
            ...
            'contact.form_success' => 'Спасибо! Я получила вашу заявку. Ответ обычно в течение суток — проверьте почту или мессенджер.',
            'contact.form_error' => 'Укажите имя и текст сообщения.',
            'contact.form_hint' => 'После отправки вы вернётесь на эту страницу с подтверждением. Также можно написать на почту или в мессенджер — ответ быстрее.',

...
<template>
  <div class="min-h-screen" style="background-color: #F5CEC7">
      ...
      <div class="container-custom">
        <div class="flex items-center justify-between py-4">
          <div class="flex items-center gap-4">
            ...
            <h1 class="text-2xl font-bold" style="color: #E79796">Категории</h1>
          </div>
    ...
    <main class="container-custom py-8">
      ...
      <div v-else-if="adminStore.categories.length === 0" class="text-center py-12" style="color: #E79796">
      ...
      <div v-else class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        >
          ...
          <h3 class="font-bold text-lg mb-2" style="color: #E79796">{{ category.name }}</h3>
          <p class="text-sm mb-4" style="color: #E79796">{{ category.description }}</p>
    ...
    <div v-if="isModalOpen" class="fixed inset-0 bg-black/50 flex items-center justify-center p-4 z-50">
      <div class="bg-white rounded-2xl shadow-soft-lg p-6 w-full max-w-md">
        ...
        <form @submit.prevent="handleSubmit" class="space-y-4">
          ...
          <div>
            <label class="block text-sm font-medium mb-2" style="color: #E79796">URL изображения *</label>
            <input
